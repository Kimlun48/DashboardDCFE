...
//         try {
//             const response = await Api.get('api/v2statisticcashpicking');
...
//     const data = [
//         { name: 'QTY ', value: totalqtylate },
//         { name: 'ITEM ', value: totalitemlate },
...
//                     <div className="text">
//                         <h4 className="chart-title">Cash Picking</h4>
//                         {total}
//                     </div>
//                 </div>
//             </div>
...
//                         <div className="square-icon" style={{ backgroundColor: '#FF6259' }}>Process</div>
...
// export default ChartCashPicking;
import React, { useState, useEffect } from "react";
...
const ChartCashPicking = () => {
    ...
    const handleClick = (entry) => {
        if (entry.name === 'QTY ' || entry.name === 'ITEM ') {
            navigate('#');
        }
    };
        ...
        <React.Fragment>
            ...
            <div className="legend">
              ...
              <div className="legend-item">
                  <div className="square-icon late"></div> Process
              </div>
          </div>
