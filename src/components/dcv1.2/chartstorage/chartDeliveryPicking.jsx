...
const ChartDeliveryPicking = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/v2statisticdeliverypicking');
    ...
    return (
        ...
        <div className="text">
        <h4 className="chart-title">Delivery Picking</h4>
        {total}
        </div>
    </div>
      </div>
...
export default ChartDeliveryPicking;