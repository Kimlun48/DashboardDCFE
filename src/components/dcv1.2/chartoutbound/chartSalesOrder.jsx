...
const ChartSalesOrder = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/v2statisticsalesorder');
        ...
        <React.Fragment>
            {/* <div className="col-12 mb-2">
                <div className="card-total">
                    <div className="text">
                        <h4 className="chart-title">Sales Order</h4>
                        {total}
                    </div>
                </div>
            </div>
                        ...
                        <ResponsiveContainer width="100%" height={300}>
                            <BarChart layout="vertical" data={data} margin={{ top: 5, right: 30, left: 10, bottom: 5 }}>
                                <defs>
                                    ...
                                    <linearGradient id="colorH-1" x1="0" y1="0" x2="1" y2="0">
...
export default ChartSalesOrder;
