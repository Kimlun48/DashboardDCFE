...
function ItrinReport() {

    //title page
    document.title = "admin-Itrin";
   ...
   // const time = 2 * 60 * 1000; 
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/v2itrin')
    ...
    const exportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "itrin");
        const excelBuffer = XLSX.write(workbook, { bookType: 'xlsx', type: 'array' });
        const data = new Blob([excelBuffer], { type: 'application/octet-stream' });
        saveAs(data, 'Inventory Transfer Request IN.xlsx');
    };
                            ...
                            <div className="card border-0 rounded shadow-sm border-top-success">
                                <div className="card-header d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <span className="font-weight-bold">Inventory Transfer Request IN</span>
