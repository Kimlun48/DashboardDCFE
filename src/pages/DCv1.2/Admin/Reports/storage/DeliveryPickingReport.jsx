...
function DeliveryPickingReport() {

    //title page
    document.title = "admin-DeliveryPicking";
   ...
   // const time = 2 * 60 * 1000; 
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/v2deliverypicking')
    ...
    const exportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "DeliveryPicking");
        const excelBuffer = XLSX.write(workbook, { bookType: 'xlsx', type: 'array' });
        const data = new Blob([excelBuffer], { type: 'application/octet-stream' });
        saveAs(data, 'Delivery Picking report.xlsx');
    };
                            ...
                            <div className="card border-0 rounded shadow-sm border-top-success">
                                <div className="card-header d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <span className="font-weight-bold">Delivery Picking</span>
...
export default DeliveryPickingReport;
