...
function ArReserveInReport() {

    //title page
    document.title = "admin-ArReserve";
   ...
   // const time = 2 * 60 * 1000; 
    ...
    const exportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "ArReserve");
        const excelBuffer = XLSX.write(workbook, { bookType: 'xlsx', type: 'array' });
        const data = new Blob([excelBuffer], { type: 'application/octet-stream' });
        saveAs(data, 'A/R Reserve Invoice report.xlsx');
    };
    ...
    const columns = [
        ...
        { name: 'Branch', selector: row => row.BRANCH, sortable: true , width:'200px'},
        ...
        { name: 'Receipt NO', selector: row => row.NO_STRUK, sortable: true , width:'200px'},
                            ...
                            <div className="card border-0 rounded shadow-sm border-top-success">
                                <div className="card-header d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <span className="font-weight-bold">ArReserve</span>
...
export default ArReserveInReport;