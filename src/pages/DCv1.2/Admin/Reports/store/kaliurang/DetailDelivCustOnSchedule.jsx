...
function KaliurangDelivCustOnScheduleDetail() {
    document.title = "Report-DetailKaliurangDelivCustOnDetailSchedule";
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/kaliurangdelivcusstorestatisticonscheduledetail');
...
export default KaliurangDelivCustOnScheduleDetail;
