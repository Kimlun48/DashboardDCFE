...
function KaliurangBinInTransitDetail() {
    document.title = "Report-DetailKaliurangBinTransitLate";
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/grpokaliurangstatisticbintransitlatedetail');
...
export default KaliurangBinInTransitDetail;
