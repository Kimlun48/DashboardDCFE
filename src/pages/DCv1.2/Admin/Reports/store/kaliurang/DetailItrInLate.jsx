...
function KaliurangItrInLateDetail() {
    document.title = "Report-DetailKaliurangItrIn";
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/kaliurangitrinstorestatisticlatedetail');
...
export default KaliurangItrInLateDetail;
