...
function KaliurangDetailItrOutBeingProcess ()
{
    document.title = "Report-DetailKaliurangItrOutBeingProcess"
    ...
    const fetchData = async () => {
        setLoading(true)
        try {
            const response = await Api.get('api/kaliurangitroutbeingprocess');
                    ...
                    <div className="col-md-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <span className="font-weight-bold">Store - Detail ITR Out Being Process</span>
                                </div>
                            </div>
...
export default KaliurangDetailItrOutBeingProcess;