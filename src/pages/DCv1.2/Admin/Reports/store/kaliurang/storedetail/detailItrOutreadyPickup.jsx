...
function KaliurangDetailItrOutReadyPickup()
{
    document.title = "Report-DetailKaliurangItrOutReadyPickup"
    ...
    const fetchData = async () => {
        setLoading(true)
        try {
            const response = await Api.get('api/kaliurangitroutreadypickup');
...
export default KaliurangDetailItrOutReadyPickup;