...
function KaliurangDetailItrInBeingProcess ()
{
    document.title = "Report-DetailKaliurangItrInBeingProcess"
    ...
    const fetchData = async () => {
        setLoading(true)
        try {
            const response = await Api.get('api/kaliurangitrinbeingprocess');
...
export default KaliurangDetailItrInBeingProcess;