...
function KaliurangDetailDelivCustBeingProcess ()
{
    document.title = "Report-DetailKaliurangDeliveryCustomerBeingProcess"
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/kaliurangdelivcusstorebeingprocess');
                    ...
                    <div className="col-md-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <span className="font-weight-bold">Store - Detail Delivery Customer Being Process</span>
                                </div>
                            </div>
...
export default KaliurangDetailDelivCustBeingProcess;