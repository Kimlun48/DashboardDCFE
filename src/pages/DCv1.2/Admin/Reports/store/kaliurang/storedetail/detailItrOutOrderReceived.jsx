...
function KaliurangDetailItrOutOrderReceived ()
{
    document.title = "Report-DetailKaliurangItrOutOrderReceived"
    ...
    const fetchData = async () => {
        setLoading(true)
        try {
            const response = await Api.get('api/kaliurangitroutorderreceived');
                    ...
                    <div className="col-md-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <span className="font-weight-bold">Store - Detail ITR Out Order Received</span>
                                </div>
                            </div>
...
export default KaliurangDetailItrOutOrderReceived;