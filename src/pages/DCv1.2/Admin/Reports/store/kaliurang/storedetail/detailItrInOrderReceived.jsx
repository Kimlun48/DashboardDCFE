...
function KaliurangDetailItrInOrderReceived ()
{
    document.title = "Report-DetailKaliurangItrInOrderReceived"
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/kaliurangitrinorderreceived');
...
export default KaliurangDetailItrInOrderReceived;