...
function KaliurangItrOutOnScheduleDetail() {
    document.title = "Report-DetailKaliurangItrOutOnDetail";
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/kaliurangitroutstorestatisticonscheduledetail');
    ...
    const columns = [
        ...
        { name: 'RECEIVING BRANCH', selector: row => row.CABANG_PENERIMA, sortable: true, width: '250px'},
                    ...
                    <div className="col-md-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <span className="font-weight-bold">Store - Detail ITR Out On Schedule</span>
                                </div>
                            </div>
...
export default KaliurangItrOutOnScheduleDetail;
