...
function KaliurangItrOutLateDetail() {
    document.title = "Report-DetailKaliurangItrOutLate";
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/kaliurangitroutstorestatisticlatedetail');
                    ...
                    <div className="col-md-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <span className="font-weight-bold">Store - Detail ITR Out Late </span>
                                </div>
                            </div>
...
export default KaliurangItrOutLateDetail;
