...
function KaliurangItrInLateDetailWarehouse() {
    document.title = "Report-DetailKaliurangItrInWarehouse";
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/kaliurangitrinwarehousetatisticlatedetail');
                    ...
                    <div className="col-md-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <span className="font-weight-bold">Warehouse - Detail ITR In Late </span>
                                </div>
                            </div>
...
export default KaliurangItrInLateDetailWarehouse;
