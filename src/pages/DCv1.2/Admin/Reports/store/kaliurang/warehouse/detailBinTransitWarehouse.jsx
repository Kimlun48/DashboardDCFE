...
function KaliurangDetailBinTransitWarehouse() {
    document.title = "Report-DetailKaliurangBinTransitWarehouse";
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/grpowarehousekaliurangdetailtransitwarehouse');
                    ...
                    <div className="col-md-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <span className="font-weight-bold">Warehouse - Detail Bin Transit Warehouse</span>
                                </div>
                            </div>
...
export default KaliurangDetailBinTransitWarehouse
