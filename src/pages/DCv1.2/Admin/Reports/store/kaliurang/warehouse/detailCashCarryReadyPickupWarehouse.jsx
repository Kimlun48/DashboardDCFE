...
function KaliurangDetailReadyPickupWarehouse ()
{
    document.title = "Report-KaliurangDetailReadyPickupWarehouse"
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/kaliurangcashcarrywarehousereadypickup');
                    ...
                    <div className="col-md-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <span className="font-weight-bold">Warehouse - Detail Cash Carry Ready Pickup</span>
                                </div>
                            </div>
...
export default KaliurangDetailReadyPickupWarehouse;