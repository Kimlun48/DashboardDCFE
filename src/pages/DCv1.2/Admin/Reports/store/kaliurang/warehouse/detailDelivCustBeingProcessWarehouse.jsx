...
function KaliurangDetailDelivCustBeingProcessWarehouse ()
{
    document.title = "Report-KaliurangDetailDelivCustBeingProcessWarehouse"
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/kaliurangdelivcuswarehouseebeingprocess');
                    ...
                    <div className="col-md-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <span className="font-weight-bold">Warehouse - Detail Delivery Customers Being Process</span>
                                </div>
                            </div>
...
export default KaliurangDetailDelivCustBeingProcessWarehouse;