...
function KaliurangDetailBeingProcessWarehouse ()
{
    document.title = "Report-KaliurangDetailBeingProcessWarehouse"
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/kaliurangcashcarrywarehousebeingprocess');
                    ...
                    <div className="col-md-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <span className="font-weight-bold">Warehouse - Detail Cash Carry Being Process</span>
                                </div>
                            </div>
...
export default KaliurangDetailBeingProcessWarehouse;