...
function KaliurangDetailDelivCustOnScheduleWarehouse ()
{
    document.title = "Report-KaliurangDetailDelivCustOnScheduleWarehouse"
    ...
    const fetchData = async () => {
        setLoading(true)
        try {
            const response = await Api.get('api/kaliurangdelivcuswarehousestatisticonscheduledetail');
                    ...
                    <div className="col-md-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <span className="font-weight-bold">Warehouse - Detail Delivery Customers On Schedule</span>
                                </div>
                            </div>
...
export default KaliurangDetailDelivCustOnScheduleWarehouse;