...
function KaliurangDetailItrOutBeingProcessWarehouse ()
{
    document.title = "Report-KaliurangDetailItrOutBeingProcessWarehouse"
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/kaliurangitroutbeingprocesswarehouse');
                    ...
                    <div className="col-md-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <span className="font-weight-bold">Warehouse - Detail ITR Out Being Process</span>
                                </div>
                            </div>
...
export default KaliurangDetailItrOutBeingProcessWarehouse;