...
function KaliurangcashCarryLateDetailWarehouse ()
{
    document.title = "Report-KaliurangcashCarryLateDetailWarehouse"
    ...
    const fetchData = async () => {
        try {
            const response = await Api.get('api/kaliurangcashcarrywarehousestatisticlatedetail');
                    ...
                    <div className="col-md-12">
                        <div className="card border-0 rounded shadow-sm border-top-success">
                            <div className="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <span className="font-weight-bold">Warehouse - Detail Cash Carry Late</span>
                                </div>
                            </div>
...
export default KaliurangcashCarryLateDetailWarehouse;