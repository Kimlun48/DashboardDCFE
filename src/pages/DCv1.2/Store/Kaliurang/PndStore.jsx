...
function StorePndKaliurang() {
    ...
    const fetchData = async () => {
        ...
        // }
        try {
            const response = await Api.get('api/kaliurangcashpndstore');
            //buat pesanan sudah bisa di ambil naik ke atas
            ...
            <div className="full-body-container">
                <div className="container mt-5 mb-5 custom-background">
                    ...
                    <div className="time-container text-right">
                        <h1 className="title">RKM STORE KALIURANG WAITING LIST CASH & CARRY</h1>
                    </div>
...
export default StorePndKaliurang;
